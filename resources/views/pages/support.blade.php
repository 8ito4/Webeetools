        ...
        <div class="max-w-xl mx-auto bg-white/80 rounded-lg shadow-md overflow-hidden" style="backdrop-filter: blur(10px);">
            <div class="px-6 py-8">
                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0 bg-yellow-100 p-3 rounded-full">
                       <svg class="w-6 h-6 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg>
                    </div>
                    <div class="ml-4">
                        <p class="text-sm font-semibold text-gray-600">WhatsApp:</p>
                        <a href="https://wa.me/5584981345425" class="text-gray-800 hover:text-yellow-600 transition-colors duration-200" target="_blank">+55 84 98134-5425</a>
                    </div>
                </div>
